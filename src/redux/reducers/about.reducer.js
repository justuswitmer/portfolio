...
import Enneagram_Light from '../../components/images/ProfileLogos/Enneagram_Light.png';
import Superpowers_Dark from '../../components/images/ProfileLogos/Superpowers_Dark.png';
import Superpowers_Light from '../../components/images/ProfileLogos/Superpowers_Light.png';
...
const about = [
  ...
  },
  {
    ...
    darkLogo: MyersBriggs_Dark,
    lightLogo: MyersBriggs_Light,
    type: ['ISTJ'], 
  ...
  {
    profile:'Enneagram', 
    darkLogo: Enneagram_Dark,
    lightLogo: Enneagram_Light,
    type: ['Type 6', 'Wing 5'], 
  ...
  {
    profile:'SuperPowers', 
    darkLogo: Superpowers_Dark,
    lightLogo: Superpowers_Light,
