...
import CloseIcon from '../images/Miscellaneous/CloseIcon.svg';
...
// const element = document.querySelector("#panel1a-header");
// element.classList.contains("Mui-expanded") ? CloseIcon : 
